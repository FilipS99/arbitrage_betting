...
def scrape_lvbet() -> Tuple[pd.DataFrame, list]:
    ...
    links = [
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=46352,46356',
         'tennis', 'two-way'),
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=20773',
         'ufc', 'two-way'),
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=37425,37427,35991,35382',
         'polish football', 'three-way'),
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=37529,37532,37533',
         'finnish football', 'three-way'),
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=21996,21985,21995,22043,22058',
         'rugby', 'three-way'),
        ('https://lvbet.pl/pl/zaklady-bukmacherskie/multiple--?leagues=37606,37307,37267,36685,36851,36582,35954,72296,72500',
        ...
        for index, element in enumerate(elements):
            ...
            if bet_outcomes == 'two-way':
                ...
                if len(item) < 7 or not item[4].replace(".", "").isnumeric() or not item[6].replace(".", "").isnumeric():
                    errors.append("LvBet: Error appending - " +
                                  " | ".join(item))
                    continue
